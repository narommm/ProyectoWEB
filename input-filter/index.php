...
<style type="text/css">
<!--
/* especificando tipo de letra, tamaño, y color de small */
.small {
...
/* dando carcteristicas a clase grey. tipo de letra, color, tamaño, borde alineacion */
.grey {
	font-family: Verdana, Arial, Helvetica, sans-serif;
	font-size: 11px;
...
/* especificando color, tamaño de letra y ancho de whitem*/
.white {
	margin-top: 8px; 
	font-weight: bold; 
...
/* estableciendo tamaño de letra de 14px */
...
} else $sample_link = '<span class="small">(<a href="index.php?use=sample">Inject sample data</a>)</span>';
...
// incluyendo archivos de la clase
...
// formulario enviado e input requerido
