...
<style type="text/css">
<--
/* aplicando carateristicas a clase small, tipode letra, pading izquierdo, color  */
.small {
...
/* aplicando carateristicas a clase grey, tipo de letra, pacdding , color, fondo, alineacion */
.grey {
	font-family: Verdana, Arial, Helvetica, sans-serif;
	font-size: 11px;
...
/* aplicando carateristicas a clase  blanca, tipo de letra, pading, color, fondo, alineacion  y ancho*/
.white {
	margin-top: 8px; 
	font-weight: bold; 
