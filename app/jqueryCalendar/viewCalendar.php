...
<script>
  ...
  $(document).ready(function() {
   var calendar = $('#calendar').fullCalendar({
    ...
    /* actualizando datos de registro */
    editable:true,
          ...
          <div class="container">
            ...
            <div class="navbar-collapse  collapse">
              ...
              <!-- creando acceso a inicio y un acerca de  -->
                 ...
                 <!-- creando menu de desplazamiendo entre vistas --><li ><a href="../../#about">About</a></li>
